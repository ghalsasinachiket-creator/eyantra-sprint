# connector_task1a.py - communication layer for Task 1A (PID Line Following).
#
# Talks to bridge_task1a.py over TCP (127.0.0.1:50002) using its JSON protocol.
...
class CoppeliaClient:
    ...
    def send_motor_command(self, left_speed, right_speed):
        ...
        cmd = {"command": "set_speed", "L": left_speed, "R": right_speed}
